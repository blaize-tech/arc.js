...
(function (IProposalType) {
    IProposalType["GenericScheme"] = "GenericScheme"; // propose a contributionReward
...
function createTransaction(options, context) {
    ...
    return function () { return __awaiter(_this, void 0, void 0, function () {
        var _a, genericScheme, transaction;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    genericScheme = context.getContract(options.scheme);
                    transaction = genericScheme.methods.proposeCall(options.callData, options.value, options.descriptionHash);
...
function createTransactionMap(options, context) {
    var _this = this;
    var eventName = 'NewCallProposal';
    var map = function (receipt) { return __awaiter(_this, void 0, void 0, function () {
        var proposalId;
        return __generator(this, function (_a) {
            proposalId = receipt.events[eventName].returnValues._proposalId;
            return [2 /*return*/, new proposal_1.Proposal(proposalId, context)];
        });
    }); };
    return map;
}
exports.createTransactionMap = createTransactionMap;
//# sourceMappingURL=genericScheme.js.map