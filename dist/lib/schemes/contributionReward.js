...
(function (IProposalType) {
    IProposalType["ContributionReward"] = "ContributionReward"; // propose a contributionReward
})(IProposalType = exports.IProposalType || (exports.IProposalType = {}));
function createProposal(options, context) {
    var _this = this;
    var contributionReward = context.getContract(options.scheme);
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    transaction = contributionReward.methods.proposeContributionReward(options.dao, options.descriptionHash || '', options.reputationReward && options.reputationReward.toString() || 0, [
                        options.nativeTokenReward && options.nativeTokenReward.toString() || 0,
                        options.ethReward && options.ethReward.toString() || 0,
                        options.externalTokenReward && options.externalTokenReward.toString() || 0,
                        options.periodLength || 0,
                        options.periods || 1
                    ], options.externalTokenAddress || utils_1.NULL_ADDRESS, options.beneficiary);
